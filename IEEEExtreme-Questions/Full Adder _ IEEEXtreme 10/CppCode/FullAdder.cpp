/****************************************************************
  This edition is typied by my team'player named Wei Jiang.
  The Laguage is C++.The score is the same with what i programed
  before.So i will try to beyond this project.
****************************************************************/
#include <iostream>
#include <cstdio>
#include <stdlib.h>
